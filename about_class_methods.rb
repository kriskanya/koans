...
class AboutClassMethods < Neo::Koan
  ...
  class Dog
    attr_accessor :name  # gives you a 'getter' method; gives us a method that looks like
    # def name = (obj)
    #   @name = obj
    # end
  end
  ...
  def Dog.name
    @name  # variables that begin with @ are instance variables, available to any method within that object
  end
